  ...
  return (
    <div className="relative w-full bg-teal-500 min-h-[24rem]  mt-32 p-10 flex items-center justify-between  z-30">
      <div className="max-w-[100vh] mx-auto md:mx-0 bg-teal-500/50 rounded-xl p-5">
        ...
        <p className="text-white max-w-xs lg:max-w-md">Make Your Event Unforgettable – Contact Us Now</p>
        <div className="my-6">
            <Button href={"contact"} title={"Get In Touch"} />
        </div>
      </div>
      <div className="lg:absolute -top-44 right-6 hidden md:block -z-10">
        <Image className='' src={"/images/hero-transparent.png"} width={800} height={800} alt='' />
      </div>
    </div>
  )
}
