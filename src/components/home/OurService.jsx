  ...
  return (
    <div className='mt-52'>
        <div className="max-w-xl mx-auto text-center">
            ...
            <p className="my-5">Our ushers are trained to handle high-profile corporate events with grace and professionalism, ensuring smooth guest management and logistics.</p>
        </div>
